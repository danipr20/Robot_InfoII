...
if(posicionamiento){enemiDetected=false;attack=false;}
	...
	enemyName=e.getName();
 	...
 	if(enemyName.equals("sample.PaintingRobot")||(!enemyName.equals("sample.PaintingRobot")&&!enemyName.equals("sample.Crazy")&&!enemyName.equals("sample.Corners")&&!enemyName.equals("0"))){
...
}  else  if (!enemyName.equals("sample.Crazy")&&!enemyName.equals("sample.Crazy")&&!enemyName.equals("sample.PaintingRobot")&&!enemyName.equals("0")) {
    bonusFire = 1;
    bonusRadar = 15;
	bonusMov=10;
